...
export default function ClerkCriminalMyDockets() {
  ...
  const handleDownloadPDF = (docket) => {
    ...
    doc.save(`CriminalDocket-${docket.term}-${docket.year}.pdf`);
  };
  ...
  return (
    <div className="container mt-4">
      <ToastContainer />
      <h2 className="text-center mb-4">My Criminal Dockets</h2>
                  ...
                  <td>
                    <div className="d-flex gap-2 flex-wrap">
                      <button 
                        ...
                        onClick={() => navigate(`/clerk/criminal-docket?id=${docket._id}`)}
      ...
      <div className="text-end mt-3">
        <button 
          ...
          onClick={() => navigate('/clerk/criminal-docket')}
        >
          Create New Docket
        </button>
      </div>
